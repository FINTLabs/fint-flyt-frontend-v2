export const FLYT_DESCRIPTION_NN =
    'Fint Flyt er ei integrasjonsplattform utvikla for å forenkle og redusere talet på integrasjonar mellom fagsystem. ' +
...
export const FAQ_NN: { header: string; content: string }[] = [
    {
        ...
        content:
            "Metadata kan nyttast i alle eigendefinerte felt. I utgåande data er det alle tekstfeltene, og i tillegg dei nedtrekksmenyane der du kan velje 'dynamisk verdi'. Dette gjer at brukaren kan byggje opp titlar, personalia eller andre felt med informasjon frå innsendt data.",
    },
    {
        header: 'Kva tyder symbola som dukkar opp når eg nyttar metadata?',
        content:
            "Dei eigendefinerte felta tillèt både fri tekst og å nytte data frå skjema. For at ein datamaskin skal kunne skilje fri tekst frå metadata, viser metadata seg på denne forma: '$if{metadata-id}'. På den måten kan systemet gjenkjenne desse referansane og bytte ut innhaldet med data frå innsendt instans. Difor er det viktig å halde forma til metadata-referansar når ein redigerer eller legg til fri tekst i eit eigendefinert felt.",
    },
    {
        header: 'Kva er ein verdikonvertering og korleis brukar eg den?',
        content:
            'Verdikonvertering er eit felt som lèt deg bruke ein definert regel for å konvertere kvar førekomst av ein verdi. Verdikonverteringar vert sett opp i menyen for verdikonvertering og brukast på same måte som metadata. Dra inn verdikonverteringa du vil nyttje, etterfylgt av verdien som skal konverterast.',
    },
    {
