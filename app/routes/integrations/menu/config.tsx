...
export const menuConfigs: { [key: string]: MenuConfig[] } = {
    ...
    channelNodes: [
        ...
        {
            nodeType: 'openObject',
            inputType: 'open-object',
            icon: 'data_object',
            label: 'Open Object 3',
        },
        {
            nodeType: 'openObject',
            inputType: 'open-object-10',
            icon: 'data_object',
            label: 'Open object 6',
        },
        {
            nodeType: 'openObject',
            inputType: 'output-object-10',
            icon: 'data_object',
            label: 'Output object',
        },
    ...
    mathNodes: [
        {
            nodeType: 'customNode',
            inputType: 'add-whole',
            label: 'Addition Whole',
            icon: 'add_circle',
        },
        {
            nodeType: 'customNode',
            inputType: 'add-float',
            label: 'Addition Float',
            icon: 'add_circle',
        },
        {
            nodeType: 'customNode',
    ...
    subFlowNodes: [
        ...
        {
            nodeType: 'subflow',
            inputType: 'subflow-reduce',
            icon: 'arrow_and_edge',
            label: 'Reduce',
        },
        {
            nodeType: 'subflow',
            inputType: 'subflow-find-first',
            icon: 'frame_inspect',
            label: 'FindFirst',
        },
    ],
